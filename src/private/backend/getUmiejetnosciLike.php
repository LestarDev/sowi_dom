...
$con = mysqli_connect('localhost','lestardev','OptimusPrime9001!','lestardev_sowka');
 ...
 if(!$con){
    ...
    $query_uzytkownik = "SELECT umiejetnosci.nazwa, umiejetnosci.lvlUmiejki, umiejetnosci.typCechy FROM `umiejetnosci` WHERE id_uzytkownika='$id' AND umiejetnosci.nazwa LIKE '%$like%';";
