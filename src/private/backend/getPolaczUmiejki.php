...
$con = mysqli_connect('localhost','lestardev','OptimusPrime9001!','lestardev_sowka');
 ...
 if(!$con){
    ...
    $query_uzytkownik = "SELECT umiejetnosci.lvlUmiejki FROM polaczUmiejki INNER JOIN umiejetnosci ON umiejetnosci.id=polaczUmiejki.id_toPolacz WHERE polaczUmiejki.id_umiejki='$id' UNION SELECT umiejetnosci.lvlUmiejki FROM umiejetnosci WHERE umiejetnosci.id='$id'; ";
