...
const useProfile = () => {
    ...
    const {nick, lvl, Umysl, Cialo, Zrecznosc, idUzytkownika, Szczescie, Urok, Niezlomnosc} = (useSelector((state) => state) as any).currency;
    ...
    return ({
        ...
        nick, lvl, Umysl, Cialo, Zrecznosc, idUzytkownika, Szczescie, Urok, Niezlomnosc
    })
